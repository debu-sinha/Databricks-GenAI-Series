...
# MAGIC
# MAGIC ## Tools
# MAGIC 1. ![Langchain](./images/LangChain_Logo-1.png) LangChain: LangChain is a framework designed to simplify the creation of applications using large It enables applications that:
...
open_ai_key = dbutils.secrets.get(scope = "doan-gen-ai-workshop", key = "open-ai-key2")
...
openAI_Chain = openAI_Chain.run({"question":user_question})
print(openAI_Chain)
